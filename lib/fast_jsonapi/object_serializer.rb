...
module FastJsonapi
  module ObjectSerializer
    ...
    def hash_for_one_record
      ...
      serializable_hash[:relationship] = self.class.get_included_records(@resource, @includes, @known_included_objects, @fieldsets, @params) if @includes.present?
      serializable_hash
    end
    ...
    def hash_for_collection
      ...
      serializable_hash[:relationship] = included if @includes.present?
      serializable_hash[:meta] = @meta if @meta.present?
      serializable_hash[:links] = @links if @links.present?
      serializable_hash
    end
